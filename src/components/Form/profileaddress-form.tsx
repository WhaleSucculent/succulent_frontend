...
import { AddressFormValues } from "pages/CheckoutPage/components/address/address-form-values.interface";
import { useTranslation } from "react-i18next";

export interface ProfileAddressFormProps {
  formName: string;
  errors?: FormikErrors<AddressFormValues>;
  touched?: FormikTouched<AddressFormValues>;
}

export const ProfileAddressForm: FunctionComponent<ProfileAddressFormProps> = ({
  formName = "address",
  errors,
  touched,
}) => {
